"""
About Me Page for OpenAI Logprobs Text Generator
Created for CodeHelwell - AI and Technology Solutions
"""
...
def show_about_page():
    ...
    with col2:
        try:
            st.image("assets/logo.png", width=300, caption="")
        except:
            st.write("**CodeHelwell**")
